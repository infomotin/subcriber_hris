    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form action="{{ route('subscriber.hris.shifts.store') }}" method="POST">
                    @csrf
                    
                    <div class="mb-3">
                        <label for="name" class="form-label fw-medium">Shift Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g. Regular Day Shift">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" class="form-control @error('late_buffer_time') is-invalid @enderror" id="late_buffer_time" name="late_buffer_time" value="{{ old('late_buffer_time', '00:15') }}">
