...
<div class="page-title-box d-flex align-items-center justify-content-between mb-4">
    <div>
        ...
        <h4 style="font-family:'Poppins',sans-serif;font-weight:700;color:#0f172a;">
            <i class="bx bx-edit text-primary me-1.5 align-middle font-size-26"></i>Edit Role: {{ $role->name }}
        </h4>
    </div>
            ...
            <div class="card border-0 shadow-sm" style="border-radius:14px;">
                <div class="card-body p-4">
                    ...
                    <div class="text-end pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-5">Update Role</button>
                    </div>
                </div>
            </div>
        </div>
