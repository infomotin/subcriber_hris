...
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
    <div>
        <h4 class="fw-bold mb-0"><i class="bx bx-shield text-primary me-2"></i> Tenant Roles</h4>
        <p class="text-muted font-size-13 mb-0">Manage roles and permission assignments for your organization.</p>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if($role->permissions->count() > 4)
                                    <span class="badge bg-light text-muted px-2 py-1 font-size-10">+{{ $role->permissions->count() - 4 }} more</span>
                                @endif
                            </td>
                            <td>
                    ...
                    @empty
                        <tr><td colspan="4" class="text-center text-muted py-4"><i class="bx bx-shield me-1"></i> No roles created yet. Click "New Role" to create one.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
